...
public class GameMain extends JPanel implements MouseListener{
	...
	public GameMain() {   
		...
		Board GameMain = new Board ();
		
		//TODO: call the method to initialize the game board
		static void myMethod() {
			  System.out.println("initialize the game board");
			}
	...
	public void paintComponent(Graphics g) {
		...
		if (currentState == GameState.Playing) {          
			...
			if (currentPlayer == Player.Cross) {   
				...
				JLabel content = new JLabel("Xs Turn");
				...
				final JLabel status = new JLabel();
                statusBar.add(status);
				JLabel content = new JLabel("Os Turn");
	  ...
	  /** Initialise the game-board contents and the current status of GameState and Player) */
		...
		public void updateGame(Player thePlayer, int row, int col) {
			...
			if(board.hasWon(thePlayer, row, col)) {
				...
				currentState = (thePlayer == Cross) ? Cross_won : Nought_won;
